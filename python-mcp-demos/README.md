...
**SOURCE**: https://github.com/Azure-Samples/python-mcp-demos
**DOWNLOADED**: 29-06-2026
**VIDEO TUTORIAL**: https://developer.microsoft.com/en-us/reactor/events/26300/?wt.mc_id=blog_26300_webpage_reactor

### .env Endpoints
OpenAI endpoint shown on the Foundry project Home page:
AZURE_OPENAI_ENDPOINT=https://YOUR-AZURE-OPENAI-SERVICE-NAME.openai.azure.com/openai/v1

Name of the model deployment (same as model unless we named it differently during deployment):
...
# Install dependencies with requirements-basic.txt
# NOTE: Trying to install all the requirements gave error
...
### TODO: Install dependencies with UV
```bash
...
### Start MCP Servers
- see .vscode/mcp.json for configuration of servers for GitHub Copilot integration.
- Clich on the "
...
**Example input:**
- Go to the GitHub Copilot Chat panel in VS Code,
...
- [Python MCP Demo](#python-mcp-demo)
  - [MY NOTES](#my-notes)
    - [.env Endpoints](#env-endpoints)
    - [Create a Virtual Environment](#create-a-virtual-environment)
    - [TODO: Install dependencies with UV](#todo-install-dependencies-with-uv)
  ...
  - [Deploy to Azure](#deploy-to-azure)
    ...
    - [Costs](#costs)
    - [Use deployed MCP server with GitHub Copilot](#use-deployed-mcp-server-with-github-copilot)
    - [Running the server locally](#running-the-server-locally)
    - [Viewing traces in Azure Application Insights](#viewing-traces-in-azure-application-insights)
    - [Viewing traces in Logfire](#viewing-traces-in-logfire)
  - [Deploy to Azure with private networking](#deploy-to-azure-with-private-networking)
    - [Additional costs for private networking](#additional-costs-for-private-networking)
  - [Deploy to Azure with Keycloak authentication](#deploy-to-azure-with-keycloak-authentication)
    - [What gets deployed](#what-gets-deployed)
    - [Deployment steps](#deployment-steps)
    - [Use Keycloak OAuth MCP server with GitHub Copilot](#use-keycloak-oauth-mcp-server-with-github-copilot)
    - [Known limitations (demo trade-offs)](#known-limitations-demo-trade-offs)
  - [Deploy to Azure with Entra OAuth Proxy](#deploy-to-azure-with-entra-oauth-proxy)
    - [What gets deployed with Entra OAuth](#what-gets-deployed-with-entra-oauth)
    - [Deployment steps for Entra OAuth](#deployment-steps-for-entra-oauth)
